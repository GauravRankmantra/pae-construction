...
const ServicesPage = () => {
  const mainServices = [
    ...
    },
    {
      ...
      description: 'Advanced engineering solutions ensuring safety and durability',
      features: [
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: 'Warehouses, manufacturing plants, and industrial structures'
    },
    {
      icon: Compass,
        ...
        <div className="container-max section-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Comprehensive construction and engineering solutions designed to bring your vision to life 
              with precision, quality, and innovation at every step.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-body text-gray-600 max-w-2xl mx-auto">
              From initial design concepts to final construction, we provide comprehensive solutions for all your building needs
            </p>
          </motion.div>
              ...
              >
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                  <div className="relative">
                    ...
                    />
                    <div className="absolute -bottom-6 -right-6 bg-black text-white p-4">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-body text-gray-600 max-w-2xl mx-auto">
              Tailored services for specific project types and industry requirements
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {specializedServices.map((service, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-black mb-3 font-montserrat">{service.title}</h3>
                <p className="text-body-small text-gray-600">{service.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            {process.map((step, index) => (
              ...
              >
                ...
                <p className="text-white/80 font-quicksand">{step.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-max section-padding">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="heading-secondary mb-6">Why Choose PAE Construction?</h2>
              <p className="text-body text-gray-600 mb-8">
                With over 15 years of experience and 200+ successful projects, we bring unmatched expertise 
                and commitment to every construction endeavor.
              </p>
            ...
            >
              ...
              />
              <div className="absolute -top-8 -left-8 bg-white border-4 border-black p-6">
                <p className="text-3xl font-bold text-black font-montserrat">15+</p>
        ...
        <div className="container-max section-padding text-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
              Let's discuss your construction needs and create a customized solution that exceeds your expectations
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/contact" className="bg-white text-black px-8 py-4 font-semibold font-montserrat transition-all duration-300 hover:bg-gray-200 inline-flex items-center">
                  Get Free Quote
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/gallery" className="border-2 border-white text-white px-8 py-4 font-semibold font-montserrat transition-all duration-300 hover:bg-white hover:text-black inline-flex items-center">
                  View Our Work
                </Link>
              </motion.div>
            </div>
